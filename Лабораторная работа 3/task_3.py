def count_letters(text):
    ...
    for current_letter in text:
        if current_letter.isalpha():
            text_letter = current_letter.lower()

            if text_letter not in letters_dict:
                letters_dict[text_letter] = 0

            letters_dict[text_letter] += 1
...
def calculate_frequency(letters_dict):
    ...
    for text_letter in letters_dict:
        letters_dict[text_letter] /= letters_sum
